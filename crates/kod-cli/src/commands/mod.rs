...
/// `kod prompt`, `kod run`, and the `--remote` variants.
mod prompt;
pub(crate) use prompt::*;

/// Inspection subcommands (jev / budget / limits / plan / decisions / trace).
mod observability;
pub(crate) use observability::*;

/// `kod fixture` — golden-transcript capture and replay.
mod fixtures;
